          ...
          <div class="box"> 
            <div class="padding-md "> 
                <div class="list-group text-center"> 
                  ...
                  <a href="/home/user/message" class="list-group-item "> <i class="text-md fa fa-bell" aria-hidden="true"></i> &nbsp;消息通知 </a> 
                  <a href="/home/user/bind" class="list-group-item active"> <i class="text-md fa fa-flask" aria-hidden="true"></i> &nbsp;账号绑定 </a> 
